...
import com.java.educenter.utils.ConstantWxUtils;
import com.java.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String callback(String code, String state) {
        ...
        try {
            ...
            //使用httpclient发送请求，得到返回结果为一个json字符串
            ...
            throw new FkException(20001,"登录失败");
        }
    }
