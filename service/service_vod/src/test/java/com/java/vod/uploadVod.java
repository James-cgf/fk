...
/**
 * @author 看文档写的上传
 * @date 2021/11/14 9:58
 */
public class uploadVod {

    //账号AK信息请填写(必选)
    private static final String accessKeyId = "LTAI5t6Ff8cQtQDtBxoNodkJ";
    //账号AK信息请填写(必选)
    private static final String accessKeySecret = "ikJwGMVsEgKSiMmQmC7ZcQ92YgfuGC";


    public static void main(String[] args) {

        // System.out.println(Init.NAME_NAME);
    ...
    //     // 任何上传方式文件名必须包含扩展名
    //     String fileName = "d:\\Users\\26384\\Desktop\\a尚学堂项目\\古粒商城\\1-阿里云上传测试视频\\6 - What If I Want to Move Faster.mp4";
    //     // 本地文件上传
