      ...
      <div class="t-infor-wrap">
        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            ...
            <section class="mt10">
              <span class="t-tag-bg">{{ this.teacher.intro }}</span>
            </section>
...
export default {
  ...
  methods:{
    getTeacherFrontInfo(){
      teacher.getTeacherFrontInfo(this.$route.params.id).then(res=>{
        console.log(res.data)
        this.teacher=res.data.data.teacher
        this.courseList=res.data.data.courseLisst
